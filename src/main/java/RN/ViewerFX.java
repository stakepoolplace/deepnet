	...
	public Pane createCommands() {
		...
		save.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
		        ...
		        String cheminDossier = "src/main/resources/models/";
		...
		loadModel.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent event) {
		        ...
		        File initialDirectory = new File("./src/main/resources/models/"); // Remplacez ceci par le chemin de votre dossier
...
//				        link.setFireTimeT(currentFireTimeT - delta);
		...
		loadDataset.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent event) {
		        ...
		        FileChooser fileChooser = new FileChooser();
		        File initialDirectory = new File("./src/main/resources/datasets/"); // Remplacez ceci par le chemin de votre dossier
		        fileChooser.setInitialDirectory(initialDirectory);
		        // Définir le filtre d'extension pour ne montrer que les fichiers .ser
